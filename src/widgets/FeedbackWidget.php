...
namespace mortscode\feedback\widgets;

use mortscode\feedback\Feedback;
use mortscode\feedback\assetbundles\feedbackwidgetwidget\FeedbackWidgetWidgetAsset;
...
class FeedbackWidget extends Widget
{
    ...
    {
        return Craft::t('feedback', 'FeedbackWidget');
    }
    ...
    {
        return Craft::getAlias("@mortscode/feedback/assetbundles/feedbackwidgetwidget/dist/img/FeedbackWidget-icon.svg");
    }
    ...
    public function getSettingsHtml(): ?string
    {
        return Craft::$app->getView()->renderTemplate(
            'feedback/_components/widgets/FeedbackWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(FeedbackWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'feedback/_components/widgets/FeedbackWidget_body',
            [
