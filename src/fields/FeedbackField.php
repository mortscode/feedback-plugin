...
use mortscode\feedback\assetbundles\feedbackfieldfield\FeedbackFieldFieldAsset;
...
class FeedbackField extends Field
{
    ...
    {
        return Craft::t('feedback', 'FeedbackField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'feedback/_components/fields/FeedbackField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(FeedbackFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').FeedbackFeedbackField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'feedback/_components/fields/FeedbackField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
